...
[Try it in the Token Factory playground](https://tokenfactory.nebius.com/playground?models=Qwen/Qwen3-235B-A22B-Instruct-2507)  (instruct model)

Try with API: [qwen3\_2507\_1.ipynb](qwen3_2507_1.ipynb) &nbsp;
[![Launch in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nebius/token-factory-cookbook/blob/main/models/qwen3_2507_1.ipynb)
...
* Try it on [Nebius Token Factory](https://tokenfactory.nebius.com/playground?models=Qwen/Qwen3-235B-A22B-Instruct-2507)
* License: Apache 2.0
